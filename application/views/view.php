...
<?php echo form_open_multipart('pelayan/dashboard/simpan') ?>
  <div class="form-row">
    <div class="form-group col-md-6">
      <label for="inputEmail4">Nama Makanan</label>
      <input type="text" name="makanan" class="form-control" id="" readonly="" value="<?php echo $makanan->makanan ?>">
    </div>
    <div class="form-group col-md-6">
      <label for="inputPassword4">Harga</label>
      <input type="text" name="harga" class="form-control" id="harga" readonly="" value="<?php echo $makanan->harga ?>">
    </div>
  </div>
